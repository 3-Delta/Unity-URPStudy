...
The [Universal Render Pipeline](https://docs.unity3d.com/Assets/URP/com.unity.render-pipelines.universal@12.1.6@latest/index.html) uses **Absolute World** as its default world space.
