...
namespace UnityEditor.Rendering.BuiltIn.ShaderGraph
{
    ...
    sealed class BuiltInTarget : Target, IHasMetadata
    {
        ...
        public static readonly string[] kSharedTemplateDirectories = GenerationUtils.GetDefaultSharedTemplateDirectories().Union(new string[] { "Assets/URP/com.unity.shadergraph@12.1.6/Editor/Generation/Targets/BuiltIn/Editor/ShaderGraph/Templates" }).ToArray();
        public const string kTemplatePath = "Assets/URP/com.unity.shadergraph@12.1.6/Editor/Generation/Targets/BuiltIn/Editor/ShaderGraph/Templates/ShaderPass.template";
    ...
    {
        const string kColor = "Assets/URP/com.unity.render-pipelines.core@12.1.6/ShaderLibrary/Color.hlsl";
        const string kTexture = "Assets/URP/com.unity.render-pipelines.core@12.1.6/ShaderLibrary/Texture.hlsl";
        const string kCore = "Assets/URP/com.unity.shadergraph@12.1.6/Editor/Generation/Targets/BuiltIn/ShaderLibrary/Core.hlsl";
        const string kLighting = "Assets/URP/com.unity.shadergraph@12.1.6/Editor/Generation/Targets/BuiltIn/ShaderLibrary/Lighting.hlsl";
        const string kGraphFunctions = "Assets/URP/com.unity.shadergraph@12.1.6/Editor/Generation/Targets/BuiltIn/ShaderLibrary/ShaderGraphFunctions.hlsl";
        const string kVaryings = "Assets/URP/com.unity.shadergraph@12.1.6/Editor/Generation/Targets/BuiltIn/Editor/ShaderGraph/Includes/Varyings.hlsl";
        const string kShaderPass = "Assets/URP/com.unity.shadergraph@12.1.6/Editor/Generation/Targets/BuiltIn/Editor/ShaderGraph/Includes/ShaderPass.hlsl";
        const string kDepthOnlyPass = "Assets/URP/com.unity.shadergraph@12.1.6/Editor/Generation/Targets/BuiltIn/Editor/ShaderGraph/Includes/DepthOnlyPass.hlsl";
        const string kShadowCasterPass = "Assets/URP/com.unity.shadergraph@12.1.6/Editor/Generation/Targets/BuiltIn/Editor/ShaderGraph/Includes/ShadowCasterPass.hlsl";

        const string kShims = "Assets/URP/com.unity.shadergraph@12.1.6/Editor/Generation/Targets/BuiltIn/ShaderLibrary/Shim/Shims.hlsl";
        const string kLegacySurfaceVertex = "Assets/URP/com.unity.shadergraph@12.1.6/Editor/Generation/Targets/BuiltIn/Editor/ShaderGraph/Includes/LegacySurfaceVertex.hlsl";
