...
namespace UnityEditor.Rendering.Universal.ShaderGraph
{
    sealed class UniversalSpriteLitSubTarget : SubTarget<UniversalTarget>, ILegacyTarget
    {
        ...
        {
            const string k2DLightingUtil = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/2D/Include/LightingUtility.hlsl";
            const string k2DNormal = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/2D/Include/NormalsRenderingShared.hlsl";
            const string kSpriteLitPass = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/2D/ShaderGraph/Includes/SpriteLitPass.hlsl";
            const string kSpriteNormalPass = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/2D/ShaderGraph/Includes/SpriteNormalPass.hlsl";
            const string kSpriteForwardPass = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/2D/ShaderGraph/Includes/SpriteForwardPass.hlsl";
