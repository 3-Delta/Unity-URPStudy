...
namespace UnityEditor.Rendering.Universal.ShaderGraph
{
...
#endif
    {
        ...
        {
            "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/ShaderGraph/Templates"
#if HAS_VFX_GRAPH
            , "Packages/com.unity.visualeffectgraph/Editor/ShaderGraph/Templates"
#endif
        }).ToArray();
        public const string kUberTemplatePath = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/ShaderGraph/Templates/ShaderPass.template";
    ...
    static class CoreIncludes
    {
        ...
        const string kCore = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/ShaderLibrary/Core.hlsl";
        const string kLighting = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/ShaderLibrary/Lighting.hlsl";
        const string kGraphFunctions = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/ShaderLibrary/ShaderGraphFunctions.hlsl";
        const string kVaryings = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/ShaderGraph/Includes/Varyings.hlsl";
        const string kShaderPass = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/ShaderGraph/Includes/ShaderPass.hlsl";
        const string kDepthOnlyPass = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/ShaderGraph/Includes/DepthOnlyPass.hlsl";
        const string kDepthNormalsOnlyPass = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/ShaderGraph/Includes/DepthNormalsOnlyPass.hlsl";
        const string kShadowCasterPass = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/ShaderGraph/Includes/ShadowCasterPass.hlsl";
        const string kTextureStack = "Assets/URP/com.unity.render-pipelines.core@12.1.6/ShaderLibrary/TextureStack.hlsl";
        const string kDBuffer = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/ShaderLibrary/DBuffer.hlsl";
        const string kSelectionPickingPass = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/ShaderGraph/Includes/SelectionPickingPass.hlsl";
