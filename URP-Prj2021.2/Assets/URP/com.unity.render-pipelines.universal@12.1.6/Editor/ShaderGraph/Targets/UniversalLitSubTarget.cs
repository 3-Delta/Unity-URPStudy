...
namespace UnityEditor.Rendering.Universal.ShaderGraph
{
    sealed class UniversalLitSubTarget : UniversalSubTarget, ILegacyTarget
    {
        ...
        public override void Setup(ref TargetSetupContext context)
        {
            ...
            var universalRPType = typeof(UnityEngine.Rendering.SelfUniversal.UniversalRenderPipelineAsset);
        ...
        {
            const string kShadows = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/ShaderLibrary/Shadows.hlsl";
            const string kMetaInput = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/ShaderLibrary/MetaInput.hlsl";
            const string kForwardPass = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/ShaderGraph/Includes/PBRForwardPass.hlsl";
            const string kGBuffer = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/ShaderLibrary/UnityGBuffer.hlsl";
            const string kPBRGBufferPass = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/ShaderGraph/Includes/PBRGBufferPass.hlsl";
            const string kLightingMetaPass = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/ShaderGraph/Includes/LightingMetaPass.hlsl";
            const string k2DPass = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/ShaderGraph/Includes/PBR2DPass.hlsl";
