...
namespace UnityEditor.Rendering.Universal.ShaderGraph
{
    sealed class UniversalDecalSubTarget : SubTarget<UniversalTarget>
    {
        ...
        public override void Setup(ref TargetSetupContext context)
        {
            ...
            context.AddCustomEditorForRenderPipeline("UnityEditor.Rendering.Universal.DecalShaderGraphGUI", typeof(UnityEngine.Rendering.SelfUniversal.UniversalRenderPipelineAsset)); // TODO: This should be owned by URP
        ...
        static class DecalPasses
        {
            public static PassDescriptor ScenePicking = new PassDescriptor()
            {
                ...
                // Template
                passTemplatePath = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/Decal/DecalPass.template",
        ...
        {
            const string kDecalInput = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/ShaderLibrary/DecalInput.hlsl";
            const string kShaderVariablesDecal = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/ShaderGraph/Includes/ShaderVariablesDecal.hlsl";
            const string kPassDecal = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Editor/ShaderGraph/Includes/ShaderPassDecal.hlsl";
            ...
            const string kGBuffer = "Assets/URP/com.unity.render-pipelines.universal@12.1.6/ShaderLibrary/UnityGBuffer.hlsl";
