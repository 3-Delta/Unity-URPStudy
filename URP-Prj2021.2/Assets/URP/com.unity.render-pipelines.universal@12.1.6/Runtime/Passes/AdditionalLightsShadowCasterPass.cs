...
namespace UnityEngine.Rendering.SelfUniversal.Internal
{
    ...
    public partial class AdditionalLightsShadowCasterPass : ScriptableRenderPass
    {
        ...
        {
            this.OverrideCameraAttachment(new RenderTargetIdentifier(m_AdditionalLightsShadowmapTexture), m_AdditionalLightsShadowmapTexture.depthStencilFormat, renderTargetWidth, renderTargetHeight, 1, true);
