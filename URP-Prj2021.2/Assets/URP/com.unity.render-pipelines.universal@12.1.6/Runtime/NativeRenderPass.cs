            ...
            using (new ProfilingScope(null, Profiling.setMRTAttachmentsList))
            {
                ...
                foreach (var passIdx in currentMergeablePasses)
                {
                    ...
                    for (int i = 0; i < validColorBuffersCount; ++i)
                    {
                        ...
                        var colorTarget = pass.overrideCameraTarget ? pass.colorAttachments[i] : this.m_ColorRT;
                        ...
                        if (existingAttachmentIndex == -1)
                        {
                            ...
                            if (pass.colorAttachments[i] == this.m_ColorRT && needCustomCameraColorClear && (clearFlag & ClearFlag.Color) != 0)
                    ...
                    m_ActiveDepthAttachmentDescriptor.ConfigureTarget(pass.overrideCameraTarget ? pass.depthAttachment : this.m_DepthRT, (clearFlag & ClearFlag.DepthStencil) == 0, true);
...
#pragma warning restore 0618
        ...
        private RenderPassDescriptor InitializeRenderPassDescriptor(CameraData cameraData, ScriptableRenderPass renderPass)
        {
            ...
            var depthTarget = renderPass.overrideCameraTarget ? renderPass.depthAttachment : this.m_DepthRT;
