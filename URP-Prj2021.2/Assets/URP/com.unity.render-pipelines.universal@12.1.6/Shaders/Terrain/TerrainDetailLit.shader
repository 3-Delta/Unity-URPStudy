Shader "Hidden/TerrainEngine/Details/UniversalPipeline/Vertexlit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Terrain/TerrainDetailLitInput.hlsl"
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Terrain/TerrainDetailLitPasses.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/ShaderLibrary/UnityGBuffer.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/UnlitInput.hlsl"
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/DepthOnlyPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Terrain/TerrainLitInput.hlsl"
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Terrain/TerrainLitDepthNormalsPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/SimpleLitInput.hlsl"
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/SimpleLitMetaPass.hlsl"
            ENDHLSL
        }
    }
