Shader "Universal Render Pipeline/Terrain/Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Terrain/TerrainLitPasses.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Terrain/TerrainLitInput.hlsl"
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Terrain/TerrainLitMetaPass.hlsl"
