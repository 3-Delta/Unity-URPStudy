...
namespace UnityEngine.Experimental.Rendering
{
    partial class ProbeGIBaking
    {
        ...
        static void InitDilationShaders()
        {
            ...
            {
                dilationShader = AssetDatabase.LoadAssetAtPath<ComputeShader>("Assets/URP/com.unity.render-pipelines.core@12.1.6/Editor/Lighting/ProbeVolume/ProbeVolumeCellDilation.compute");
