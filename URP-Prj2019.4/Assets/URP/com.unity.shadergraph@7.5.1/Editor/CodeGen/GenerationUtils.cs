...
namespace UnityEditor.ShaderGraph
{
    static class GenerationUtils
    {
            ...
            List<Dependency[]> dependencies, string resourceClassName, string assemblyName)
        {
            ...
            string templatePath = "Assets/URP/com.unity.render-pipelines.universal@7.5.1/Editor/ShaderGraph/Templates";
        ...
        {
            var basePath = "Assets/URP/com.unity.shadergraph@7.5.1/Editor/Templates/";
