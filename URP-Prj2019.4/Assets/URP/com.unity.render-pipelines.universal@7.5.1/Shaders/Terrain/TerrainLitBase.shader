Shader "Hidden/Universal Render Pipeline/Terrain/Lit (Base Pass)"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@7.5.1/Shaders/Terrain/TerrainLitInput.hlsl"
            #include "Assets/URP/com.unity.render-pipelines.universal@7.5.1/Shaders/Terrain/TerrainLitPasses.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@7.5.1/Shaders/Terrain/TerrainLitInput.hlsl"
            #include "Assets/URP/com.unity.render-pipelines.universal@7.5.1/Shaders/Terrain/TerrainLitMetaPass.hlsl"
