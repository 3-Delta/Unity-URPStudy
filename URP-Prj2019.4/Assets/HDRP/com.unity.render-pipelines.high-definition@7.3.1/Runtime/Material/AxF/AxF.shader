...
//      [ToggleUI] _EnableBlendModePreserveSpecularLighting("Enable Blend Mode Preserve Specular Lighting", Float) = 1.0
    ...
    #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/AxF/AxFProperties.hlsl"
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/AxF/AxF.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/AxF/ShaderPass/AxFDepthPass.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/AxF/AxFData.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Material.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/AxF/AxF.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/AxF/ShaderPass/AxFSharePass.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/AxF/AxFData.hlsl"
