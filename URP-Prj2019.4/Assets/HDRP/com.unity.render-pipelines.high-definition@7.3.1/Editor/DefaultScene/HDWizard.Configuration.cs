...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    partial class HDWizard
    {
        ...
        bool IsDXRShaderConfigCorrect()
        {
            ...
            bool found = false;
            using (StreamReader streamReader = new StreamReader("LocalAssets/HDRP/com.unity.render-pipelines.high-definition@7.3.1-config/Runtime/ShaderConfig.cs.hlsl"))
            {
        ...
        void FixDXRShaderConfig(bool fromAsyncUnused)
        {
            ...
            else
            {
                ...
                string[] lines = System.IO.File.ReadAllLines("LocalAssets/HDRP/com.unity.render-pipelines.high-definition@7.3.1-config/Runtime/ShaderConfig.cs.hlsl");
                ...
                File.WriteAllLines("LocalAssets/HDRP/com.unity.render-pipelines.high-definition@7.3.1-config/Runtime/ShaderConfig.cs.hlsl", lines);
            }
        }
        ...
        const string k_LocalHdrpConfigPackagePath = "LocalAssets/HDRP/com.unity.render-pipelines.high-definition@7.3.1-config";
