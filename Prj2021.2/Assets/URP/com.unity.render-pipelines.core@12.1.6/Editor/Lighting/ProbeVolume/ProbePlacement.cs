    ...
    class ProbePlacement
    {
        ...
        static ComputeShader subdivideSceneCS
        {
            get
            {
                ...
                {
                    _subdivideSceneCS = AssetDatabase.LoadAssetAtPath<ComputeShader>("Assets/URP/com.unity.render-pipelines.core@12.1.6/Editor/Lighting/ProbeVolume/ProbeVolumeSubdivide.compute");
