...
namespace UnityEditor
{
    ...
    public class LightAnchorEditorTool : EditorTool
    {
        ...
        void OnEnable()
        {
            m_IconContent = new GUIContent(UnityEditor.Rendering.CoreEditorUtils.LoadIcon(@"Assets/URP/com.unity.render-pipelines.core@12.1.6/Editor/Lighting/Icons/", "LightAnchor_Icon", ".png", false));
        }
