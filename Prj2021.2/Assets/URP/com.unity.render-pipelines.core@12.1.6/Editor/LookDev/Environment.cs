...
namespace UnityEditor.Rendering.LookDev
{
    ...
    class EnvironmentElement : VisualElement, IBendable<Environment>
    {
        ...
        public VisualElement GetDefaultInspector()
        {
            ...
            {
                image = CoreEditorUtils.LoadIcon(@"Assets/URP/com.unity.render-pipelines.core@12.1.6/Editor/LookDev/Icons/", "Environment", forceLowRes: true)
            });
            ...
            {
                image = CoreEditorUtils.LoadIcon(@"Assets/URP/com.unity.render-pipelines.core@12.1.6/Editor/LookDev/Icons/", "SunPosition", forceLowRes: true)
            });
