...
namespace UnityEditor.Rendering.Universal.Converters
{
    ...
    internal static class ReadonlyMaterialMap
    {
        ...
        {
            {"Default-Diffuse", "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Runtime/Materials/Lit.mat"},
            {"Default-Material", "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Runtime/Materials/Lit.mat"},
            {"Default-ParticleSystem", "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Runtime/Materials/ParticlesUnlit.mat"},
            {"Default-Particle", "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Runtime/Materials/ParticlesUnlit.mat"},
            {"Default-Terrain-Diffuse", "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Runtime/Materials/TerrainLit.mat"},
            {"Default-Terrain-Specular", "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Runtime/Materials/TerrainLit.mat"},
            {"Default-Terrain-Standard", "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Runtime/Materials/TerrainLit.mat"},
            {"Sprites-Default", "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Runtime/Materials/Sprite-Unlit-Default.mat"},
            {"Sprites-Mask", "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Runtime/Materials/Sprite-Unlit-Default.mat"},
            {"SpatialMappingOcclusion", "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Runtime/Materials/SpatialMappingOcclusion.mat"},
            {"SpatialMappingWireframe", "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Runtime/Materials/SpatialMappingWireframe.mat"},

            // TODO: These currently render in URP, but they are using BIRP shaders. Create a task to convert these.
            // {"Default UI Material", "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Runtime/Materials/Lit.mat"},
            // {"ETC1 Supported UI Material", "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Runtime/Materials/Lit.mat"},
            // {"Default-Line", "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Runtime/Materials/Lit.mat"},
            // {"Default-Skybox", "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Runtime/Materials/Lit.mat"},
        };
    }
