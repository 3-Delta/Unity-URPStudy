...
Shader "Universal Render Pipeline/Particles/Simple Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Particles/ParticlesSimpleLitForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Particles/ParticlesSimpleLitGBufferPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Particles/ParticlesDepthOnlyPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Particles/ParticlesDepthNormalsPass.hlsl"
            ENDHLSL
        }
        // ------------------------------------------------------------------
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Particles/ParticlesEditorPass.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Utils/Universal2D.hlsl"
            ENDHLSL
        }
    }
