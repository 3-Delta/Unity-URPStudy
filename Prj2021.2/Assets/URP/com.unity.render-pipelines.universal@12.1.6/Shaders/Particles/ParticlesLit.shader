...
Shader "Universal Render Pipeline/Particles/Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Particles/ParticlesLitInput.hlsl"
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Particles/ParticlesLitForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Particles/ParticlesLitInput.hlsl"
            #include "Assets/URP/com.unity.render-pipelines.universal@12.1.6/Shaders/Particles/ParticlesLitGbufferPass.hlsl"
            ENDHLSL
        }
