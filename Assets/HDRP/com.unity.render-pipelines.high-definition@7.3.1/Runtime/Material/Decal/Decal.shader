Shader "HDRP/Decal"
{
    ...
    #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Decal/DecalProperties.hlsl"
    ...
    SubShader
    {
		...
		Pass
		{
            ...
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Decal/Decal.hlsl"
			#include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Decal/ShaderPass/DecalSharePass.hlsl"
			#include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Decal/DecalData.hlsl"
			#include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/RenderPipeline/ShaderPass/ShaderPassDecal.hlsl"
