...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    class HDEditorUtils
    {
        internal const string FormatingPath =
            @"Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Editor/USS/Formating";
        internal const string QualitySettingsSheetPath =
            @"Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Editor/USS/QualitySettings";
        internal const string WizardSheetPath =
            @"Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Editor/USS/Wizard";
