Shader "Hidden/HDRP/DrawTransmittanceGraph"
{
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/ShaderLibrary/EditorShaderVariables.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/DiffusionProfile/DiffusionProfile.hlsl"
