Shader "HDRP/Lit"
{
    ...
    // #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/Lit.cs.hlsl"
    #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/LitProperties.hlsl"
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/ShaderPass/LitDepthPass.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/LitData.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Material.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/Lit.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/ShaderPass/LitSharePass.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/LitData.hlsl"

            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/RenderPipeline/ShaderPass/ShaderPassGBuffer.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/ShaderPass/LitSharePass.hlsl"
            #else
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/ShaderPass/LitMotionVectorPass.hlsl"
            #endif
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/LitData.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Material.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/Lit.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/ShaderPass/LitDistortionPass.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/LitData.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/ShaderPass/LitSharePass.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/LitData.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/RenderPipeline/ShaderPass/ShaderPassForward.hlsl"
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #define HAS_LIGHTLOOP
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/Lit.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/LitRaytracing.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Material.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/RenderPipeline/Raytracing/Shaders/ShaderVariablesRaytracing.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/RenderPipeline/Raytracing/Shaders/SubSurface/RaytracingIntersectionSubSurface.hlsl"

            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/Lit.hlsl"

            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/RenderPipeline/Raytracing/Shaders/RayTracingCommon.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/Material/Lit/LitData.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition@7.3.1/Runtime/RenderPipeline/ShaderPass/ShaderPassRaytracingSubSurface.hlsl"
