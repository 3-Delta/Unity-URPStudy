...
Shader "Hidden/TerrainEngine/Details/UniversalPipeline/WavingDoublePass"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/URP/com.unity.render-pipelines.universal@7.5.1/Shaders/Terrain/WavingGrassInput.hlsl"
            #include "Assets/URP/com.unity.render-pipelines.universal@7.5.1/Shaders/Terrain/WavingGrassPasses.hlsl"
